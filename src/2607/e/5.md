...
Unlike the sCPU, we will continue improving the NPC in the future by adding more features. 
Therefore, it is necessary to maintain the NPC project properly and prepare it for future extensions. 
For example, during the D stage, you will implement approximately 40 instructions in the NPC.
One way to improve code maintainability is through modular design.
