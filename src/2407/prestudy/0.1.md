...
> #### todo::Complete the General Education Questionnaire
> Before starting the first task of the F stage, please carefully read the content in sections ["Signup"](https://ysyx.oscc.cc/en/signup/) and ["FAQ"](https://ysyx.oscc.cc/en/project/faq.html)Note: The General Education Questionnaire can be completed multiple times, and only by achieving a score of 100 can one apply for the pre-study defense.
